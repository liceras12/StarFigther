...
void ACapsulaEnergia2::BeginPlay()
{
	Super::BeginPlay();

	Nombre = "Capsula energia 02";
...
void ACapsulaEnergia2::Generar()
{
	GEngine->AddOnScreenDebugMessage(-1, 15.0f, FColor::Emerald, TEXT("Generando una capsula de energia02"));
}
